...
Хоть [технология строительства](/?p=34) и была нам не до конца ясна, но мы знали наверняка, что:

**·** дом будет круглым;

**·** [дом будет вкопан в холм](/?p=32) и обвалован, будет зелёная кровля. Имеется ввиду не покрашенная в зелёный цвет, а с травой;

**·** [дом будет ориентирован по Солнцу](/?p=31) и иметь только южные, юго-восточные и юго-западные окна;

**·** отопление — [печь](/?p=29), но предусмотреть возможность в будущем [поставить солнечный водонагреватель и сделать тёплый пол;](/?p=30)

**·** дом должен быть [инерционным](/?p=15)
...
Всё, думаю что хватит на сегодня. В [следующий раз](/?p=32) прочитаете почему я закопал свой дом.
